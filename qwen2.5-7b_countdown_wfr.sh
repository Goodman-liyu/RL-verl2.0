...
export EXPERIMENT_NAME=${DataName}_7b_base_with_format
export VLLM_ATTENTION_BACKEND=XFORMERS
export LOG_FILE=log/${DataName}_7b_base_with_format.log
...
do
    python scripts/model_merger.py --local_dir=checkpoints/Nips/countdown_v2_7b_base_with_format/global_step_${step}/actor
done