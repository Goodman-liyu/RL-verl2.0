...
PREFIX="""
A conversation between User and Assistant. The User asks a question, and the Assistant solves it. The Assistant first thinks about the reasoning process in the mind and then provides the User with the answer. The reasoning process is enclosed  within <think> </think> and answer is enclosed within <answer> </answer> tags, respectively, i.e., <think> reasoning process here </think> <answer> answer here </answer>. Now the user asks you to solve a math problem. After thinking, when you finally reach a conclusion, clearly state the answer within <answer> </answer> tags. i.e., <answer> </answer>.
""".strip()
...
def process(sample):
    ...
    prompt = PREFIX + "\n\n" + INSTRUCTIONS.format(puzzle=puzzle, json_template=demo)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/zebra_v2')
